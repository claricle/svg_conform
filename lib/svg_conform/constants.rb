...
module SvgConform
  module Constants
    ...
    SVG_PROPERTIES = {
      ...
      'shape-rendering' => %w[auto optimizeSpeed crispEdges geometricPrecision inherit],
      'text-rendering' => %w[auto optimizeSpeed optimizeLegibility geometricPrecision inherit],
      ...
      'font-weight' => %w[normal bold bolder lighter inherit 100 200 300 400 500 600 700 800 900],
