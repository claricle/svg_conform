...
module SvgConform
  ...
  autoload :ConformanceReport, File.expand_path('svg_conform/conformance_report', __dir__)
  autoload :ReportComparator, File.expand_path('svg_conform/report_comparator', __dir__)
  ...
  module Commands
    ...
    autoload :Compatibility, File.expand_path('svg_conform/commands/compatibility', __dir__)
    autoload :GenerateReports, File.expand_path('svg_conform/commands/generate_reports', __dir__)
