...
RSpec.describe SvgConform::Requirements::NamespaceAttributesRequirement do
  ...
  fixture_files.each do |fixture_name|
    describe "fixture: #{fixture_name}" do
      let(:input_file) { "spec/fixtures/namespace_attributes/inputs/#{fixture_name}.svg" }
      let(:expected_output_file) { "spec/fixtures/namespace_attributes/repair/#{fixture_name}.svg" }
