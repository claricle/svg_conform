...
RSpec.describe SvgConform::Requirements::ColorRestrictionsRequirement do
  ...
  fixture_files.each do |fixture_name|
    describe "fixture: #{fixture_name}" do
      let(:input_file) { "spec/fixtures/color_restrictions/inputs/#{fixture_name}.svg" }
      let(:expected_output_file) { "spec/fixtures/color_restrictions/repair/#{fixture_name}.svg" }
