...
RSpec.describe SvgConform::Requirements::ForbiddenContentRequirement do
  ...
  fixture_files.each do |fixture_name|
    describe "fixture: #{fixture_name}" do
      let(:input_file) { "spec/fixtures/forbidden_content/inputs/#{fixture_name}.svg" }
      let(:expected_output_file) { "spec/fixtures/forbidden_content/repair/#{fixture_name}.svg" }
