...
svg_conform svgcheck generate --mode both
...
[source,bash]
----
svg_conform svgcheck generate [OPTIONS]
...
svg_conform svgcheck generate --mode repair

# Process a single file with verbose output
svg_conform svgcheck generate --single-file example.svg --verbose

# Force regeneration of existing outputs
svg_conform svgcheck generate --force

# Use custom output directory
svg_conform svgcheck generate --fixtures-path /path/to/custom/output
----
