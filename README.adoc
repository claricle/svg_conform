...
The `compare` command compares SvgConform validation results with existing
...
[source,bash]
----
svg_conform compare FILE [OPTIONS]
...
$ svg_conform compare diagram.svg -p svg_1_2_rfc

# Specify svgcheck report explicitly
$ svg_conform compare diagram.svg --svgcheck-report diagram.svg.svgcheck.yaml
----
